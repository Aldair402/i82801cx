...
typedef struct southbridge_intel_i82801cx_config config_t;
...
static void i82801cx_pirq_init(struct device *dev)
{
...
static void i82801cx_power_options(struct device *dev)
{
	u8 reg8;
	u16 reg16, pmbase;
	u32 reg32;
...
static void i82801cx_set_acpi_mode(struct device *dev)
{
...
static void i82801cx_lpc_route_dma(struct device *dev, u8 mask)
{
	u16 reg16;
	int i;
...
static void lpc_init(struct device *dev)
{
	...
	/* Setup the PIRQ. */
	i82801cx_pirq_init(dev);

	/* Setup power options. */
	i82801cx_power_options(dev);
	...
	i82801cx_set_acpi_mode(dev);
}

static void i82801cx_lpc_read_resources(struct device *dev)
{
	struct resource *res;
